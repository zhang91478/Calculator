...
public class ActivityFour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText1 = (EditText)findViewById(R.id.edit_text4_1);
        editText1.setInputType(InputType.TYPE_NULL);
        editText1.setText("0");
        editText2 = (EditText)findViewById(R.id.edit_text4_2);
        editText2.setInputType(InputType.TYPE_NULL);
        editText2.setText("0");
        editText3 = (EditText)findViewById(R.id.edit_text4_3);
        editText3.setInputType(InputType.TYPE_NULL);
        editText3.setText("0");

        Spinner spinner1 = (Spinner)findViewById(R.id.spinner4_1);
        spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    ...
                    case 2:rate1 =2589988.110336;break;
                    case 3:rate1 =4046.8564224;break;
                    case 4:rate1 =0.0006452;break;
                    case 5:rate1 =10000;break;
                }
        ...
        Spinner spinner2 = (Spinner)findViewById(R.id.spinner4_2);
        spinner2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    ...
                    case 2:rate2 =2589988.110336;break;
                    case 3:rate2 =4046.8564224;break;
                    case 4:rate2 =0.0006452;break;
                    case 5:rate2 =10000;break;
                }
        ...
        Spinner spinner3 = (Spinner)findViewById(R.id.spinner4_3);
        spinner3.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    ...
                    case 2:rate3 =2589988.110336;break;
                    case 3:rate3 =4046.8564224;break;
                    case 4:rate3 =0.0006452;break;
                    case 5:rate3 =10000;break;
                }
        ...
        Button button5 = (Button)findViewById(R.id.button4_5);
        buttonAction(button5,"5");

        Button button6 = (Button)findViewById(R.id.button4_6);
        buttonAction(button6,"6");

        Button button7 = (Button)findViewById(R.id.button4_7);
        buttonAction(button7,"1");

        Button button8 = (Button)findViewById(R.id.button4_8);
        buttonAction(button8,"2");

        Button button9 = (Button)findViewById(R.id.button4_9);
        buttonAction(button9,"3");

        Button button10 = (Button)findViewById(R.id.button4_10);
        buttonAction(button10,"0");

        Button button11 = (Button)findViewById(R.id.button4_11);
        buttonAction(button11,"00");

        Button button12 = (Button)findViewById(R.id.button4_12);
        buttonAction(button12,".");

        Button button13 = (Button)findViewById(R.id.button4_13);
        ...
        Button button14 = (Button)findViewById(R.id.button4_14);
